Public Class Main
	...
	'I have used lists, text boxes, labels and radio buttons as components that we're drag and dropped.
	'I have also used some class components such as messagebox which we're not dragged and dropped
	'This is along with other functions such as print and tooltips which are dragged and dropped but then set as an non visual component
    ...
    Private Sub dropDown_occ_SelectedIndexChanged(sender As Object, e As EventArgs) Handles dropDown_occ.SelectedIndexChanged
        ...
        'This is a selection statement using the keywords If & Else
    ...
    Private Sub button_submit_Click(sender As Object, e As EventArgs) Handles button_submit.Click
        ...
        'Array function from Stackoverflow & VB.Net reference
         'This is a selection statement using the keywords If 
     ...
     'This is a selection statement using the keywords If 
      ...
      'This is a selection statement using the keywords If 
       ...
       'This is a selection statement using the keywords If 
        ...
        'This is a selection statement using the keywords If, ElseIf & Else
        
        'Split into array for first section
        Dim emailPart1(1) As String ' Part 1 temp array
        'String variable has split by character part.
       ...
       'This is a selection statement using the keywords If
        ...
        'Company
         'This is a selection statement using the keywords If which then has a nested If
    ...
    Private Sub reset_tab1()
    	'This uses sequence to process resetting of the form
    ...
    Private Sub spinner_Id_ValueChanged(sender As Object, e As EventArgs) Handles spinner_Id.ValueChanged
		'On the event that the spinner box element is changed. 
    ...
    Private Sub updateTicket(id As Integer)
        ...
        'A method of selection checking if it is not equal to N/A
	...
	'This is an selection statement using the keywords, If, ElseIf & Else
	  If (TicketArray(1) = 0) Then
			...
			'This uses functions found in the items form element.
