Public Class Main
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'Could be seen as sequence from where it goes through all of these in sequence
    ...
    Private Sub button_submit_Click(sender As Object, e As EventArgs) Handles button_submit.Click
        ...
        'Array function from Stackoverflow & VB.Net reference
         'Selection with an Or statement to do two parts using a function and length
        ...
        'Dropbox occupation
        'This uses selection to see if Select is selected.
        ...
        'Company
         'This uses selection twice to check if one part is selected and if a company name is 5 characters.
        ...
        'This uses selection to test if it equals Select. 
